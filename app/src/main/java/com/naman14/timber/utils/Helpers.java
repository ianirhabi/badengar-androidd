...
public class Helpers {
    ...
    public static class AboutDialog extends DialogFragment {
        ...
        String urlfacebook = "https://web.facebook.com/ian.alif.3";
        String urlcommunity = "https://plus.google.com/communities/111029425713454201429";
        String urltwitter = "https://www.instagram.com/programmer_jalanan/";
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            TextView facebook = (TextView) aboutBodyView.findViewById(R.id.googleplus);
...
//            });
            try {
                ...
                appversion.setText("Badengar " + "1.0");
