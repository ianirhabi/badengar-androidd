...
public class Constants {
    ...
    public static final String TIMBER1 = "badengar1";
    public static final String TIMBER2 = "badengar2";
    public static final String TIMBER3 = "badengar3";
    public static final String TIMBER4 = "badengar4";
    public static final String TIMBER5 = "badengar5";
    public static final String TIMBER6 = "badengar6";
